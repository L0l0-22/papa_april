...
export default function SignForm() {
    ...
    return (
        <form className="bg-white px-6 py-8 md:p-10 lg:p-20 w-full rounded-md" onSubmit={handleSubmit}>
            <h2 className="text-3xl font-semibold text-left w-full leading-relaxed ">
                <span className="text-darkRed font-bold">Sign Up</span> To Your Papa Johns Account For More Pizza Offers And Exclusive   <br className="hidden sm:block" />  Rewards
            </h2>
            ...
            <p className='font-normal text-sm pt-5'>
                Already have an account? <Link href="/signin" className="font-bold text-base">sign in</Link>
            </p>
        </form>
    );
}